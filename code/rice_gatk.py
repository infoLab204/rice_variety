...
print(f"jar -jar {PICARD} MarkDuplicates I={root_dir}{alignment}/temp/{samp_name}.fixmated.sored.bam O={root_dir}{alignment}/{samp_name}_aligned.bam M={root_dir}{alignment}/temp/{samp_name}.markdup.metrics.txt")
